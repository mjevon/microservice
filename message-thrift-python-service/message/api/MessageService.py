...
class Iface(object):
    def sendMessage(self, mobile, message):
        """
        Parameters:
         - mobile
         - message
...
class Client(Iface):
    ...
    def sendMessage(self, mobile, message):
        ...
        Parameters:
         ...
         - message
        """
        self.send_sendMessage(mobile, message)
        return self.recv_sendMessage()

    def send_sendMessage(self, mobile, message):
...
class Processor(Iface, TProcessor):
    ...
    def process_sendMessage(self, seqid, iprot, oprot):
        ...
        result = sendMessage_result()
        try:
            result.success = self._handler.sendMessage(args.mobile, args.message)
